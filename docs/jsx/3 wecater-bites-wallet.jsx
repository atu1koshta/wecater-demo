...
const REDEMPTION_HISTORY = [
  ...
  },
  {
    ...
    bites: 6500,
    value: 65.0,
    type: "WeCater catering credit · 1.2X",
    code: "Used at Pita Jungle",
  },
  {
    date: "Jan 8",
    bites: 2500,
        ...
        {[
          ...
          <button
            ...
            style={{
              ...
              boxShadow:
                tab.id === "rewards" ? "0 1px 3px rgba(0,0,0,0.04)" : "none",
...
function RedeemModal({ availableBites, onClose }) {
  ...
  const valueAtRoute = useMemo(() => {
    ...
    if (selectedRoute === "boost" && selectedRestaurant)
      return (selectedBites / 100) * selectedRestaurant.boostMultiplier;
    return 0;
  ...
  const boostableRestaurants = RESTAURANT_BUCKETS.filter(
    (r) => r.boostable && r.earnedBites >= 1000,
  );
  const minForCurrentRoute = ROUTE_MIN[selectedRoute] || 1000;
  const canRedeem =
    selectedBites >= minForCurrentRoute &&
    (selectedRoute !== "boost" || selectedRestaurant);
        ...
        {step === 0 && (
          <div>
            ...
            <div style={{ padding: 24 }}>
                ...
                {presets.map((p) => (
                  <button
                    ...
                    style={{
                      ...
                      background: selectedBites === p ? T.brandLight : T.card,
                      color: selectedBites === p ? T.brandDark : T.text,
                      transition: "all 0.15s",
                    }}
                  >
              ...
              <button
                onClick={() => !wecaterLocked && setSelectedRoute("wecater")}
                ...
                style={{
                  ...
                  background:
                    selectedRoute === "wecater" ? T.brandLight : T.card,
                  display: "flex",
                  alignItems: "center",
                  gap: 12,
                  position: "relative",
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  ...
                  >
                    ...
                    <span
                      style={{
                        ...
                        padding: "1px 6px",
                        borderRadius: 4,
                        background: wecaterLocked ? T.textTertiary : T.brand,
                        color: "#fff",
                        fontWeight: 700,
                  ...
                  <div
                    style={{
                      fontSize: 11,
                      color: wecaterLocked ? T.warning : T.textTertiary,
                      marginTop: 2,
                      lineHeight: 1.45,
                    }}
                  >
                    {wecaterLocked ? (
                      <>
                        Save up to <strong>2,500 Bites</strong> to unlock the
                        1.2X bonus on WeCater catering credit
                      </>
                    ) : (
                      <>
                        Use Bites toward your next WeCater order at any
                        restaurant · {selectedBites.toLocaleString()} Bites = $
                        {((selectedBites / 100) * 1.2).toFixed(2)} of credit
                      </>
                    )}
                  </div>
                </div>
                {!wecaterLocked && (
                  <div
                    style={{
                      ...
                      height: 18,
                      borderRadius: "50%",
                      border: `2px solid ${selectedRoute === "wecater" ? T.brand : T.border}`,
                      position: "relative",
                      flexShrink: 0,
                    }}
                  >
                    {selectedRoute === "wecater" && (
                      <div
                        style={{
                          position: "absolute",
                          inset: 3,
              ...
              <button
                onClick={() => {
                  setSelectedRoute("boost");
                  if (!selectedRestaurant)
                    setSelectedRestaurant(boostableRestaurants[0]);
                }}
                style={{
                  width: "100%",
                  padding: 14,
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  ...
                  >
                    Spend at a restaurant where you earned Bites — they boost
                    the redemption rate
                  </div>
                </div>
                <div
                  style={{
                    ...
                    height: 18,
                    borderRadius: "50%",
                    border: `2px solid ${selectedRoute === "boost" ? T.brand : T.border}`,
                    position: "relative",
                    flexShrink: 0,
                  }}
                >
              ...
              {/* Route 3: Amazon */}
              <button
                onClick={() => setSelectedRoute("amazon")}
                style={{
                  width: "100%",
                  padding: 14,
                  borderRadius: 10,
                  ...
                  background:
                    selectedRoute === "amazon" ? T.brandLight : T.card,
                  display: "flex",
                  alignItems: "center",
                  gap: 12,
                }}
              >
                ...
                <div style={{ flex: 1 }}>
                  ...
                  >
                    Sent to your personal email · standard 1.0X rate · min 1,000
                    Bites
                  </div>
                </div>
                <div
                  style={{
                    ...
                    height: 18,
                    borderRadius: "50%",
                    border: `2px solid ${selectedRoute === "amazon" ? T.brand : T.border}`,
                    position: "relative",
                    flexShrink: 0,
                  }}
                >
                ...
                >
                  ...
                  <span style={{ fontSize: 12, opacity: 0.85 }}>
                    ...
                    {selectedRoute !== "amazon" && (
                      ...
                      >
                        +${(valueAtRoute - selectedBites / 100).toFixed(2)}{" "}
                        bonus
                      </span>
                    )}
                  </span>
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  fontWeight: 600,
                  fontSize: 13,
                  cursor: !canRedeem ? "default" : "pointer",
                  fontFamily: font,
                }}
              >
        ...
        {step === 1 && (
          <div style={{ padding: "40px 24px", textAlign: "center" }}>
            ...
            >
              ...
              {selectedRoute === "boost" &&
                `${selectedBites.toLocaleString()} Bites locked in for your next ${selectedRestaurant?.name} order at ${selectedRestaurant?.boostMultiplier}X.`}
              {selectedRoute === "amazon" &&
            ...
            >
              <strong style={{ color: T.text, fontFamily: fontMono }}>
                WCR-{Math.random().toString(36).substring(2, 6).toUpperCase()}-
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: "24px 28px 40px" }}>
          ...
          >
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              ...
              <div style={{ fontSize: 13, opacity: 0.85, marginBottom: 22 }}>
                ...
                <strong>${(dollarValue * 1.5).toFixed(2)}</strong> with
                Restaurant Boost · {wallet.pendingBites.toLocaleString()}{" "}
                pending
              </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            ...
            >
              ...
              >
                ...
                >
                  +${EZCATER_COMPARISON.spread.toFixed(0)}
                </span>
                <span
                  style={{
                    fontSize: 11,
              ...
              >
                ...
                <strong style={{ color: T.text }}>
                  {EZCATER_COMPARISON.ezcaterBitesEquivalent.toLocaleString()}{" "}
                  ezCater points (${EZCATER_COMPARISON.ezcaterValue.toFixed(2)})
                </strong>
                . WeCater earned you{" "}
                <strong style={{ color: T.brand }}>
                  {EZCATER_COMPARISON.wecaterBites.toLocaleString()} Bites ($
                  {EZCATER_COMPARISON.wecaterValue.toFixed(2)})
                </strong>
                .
              </div>
              <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                <div>
                  ...
                  >
                    ...
                    >
                      {EZCATER_COMPARISON.wecaterBites.toLocaleString()}
                    </span>
                  </div>
                  <div
                    style={{
                ...
                <div>
                  ...
                  >
                    <span style={{ color: T.textTertiary }}>
                      ezCater · ~1.5% effective
                    </span>
                    <span
                      style={{ color: T.textTertiary, fontFamily: fontMono }}
                    >
                      {EZCATER_COMPARISON.ezcaterBitesEquivalent.toLocaleString()}
                    </span>
                  </div>
                  ...
                  >
                    <div
                      style={{
                        height: "100%",
                        width: `${(EZCATER_COMPARISON.ezcaterBitesEquivalent / EZCATER_COMPARISON.wecaterBites) * 100}%`,
            ...
            >
              ...
              >
                ...
                >
                  {wallet.ytdBitesEarned.toLocaleString()}
                </div>
                <div
                  style={{
                    fontSize: 10,
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                The full meal cost is charged to your corporate card and
                reported under{" "}
                <strong style={{ color: T.text }}>CMS Open Payments</strong> as
                a transfer of value to attending physicians. Standard business
                expense.
              </div>
            </div>
            ...
            >
              ...
              >
                ...
                <strong style={{ color: T.text }}>loyalty incentive</strong> to
                win your future business. Treated as a{" "}
                <strong style={{ color: T.text }}>rebate</strong>, not income —
                same legal model the airlines use.
              </div>
            </div>
          </div>
          ...
          {showHowItWorks && (
            ...
            >
              ...
              >
                ...
                company pays the restaurant directly for catering — that's a
                normal business expense reported per-physician for compliance.
                Restaurants on WeCater offer Bites as a marketing incentive,
                similar to how credit cards offer points or airlines award
                miles. The Bites are a discount on future spending, paid to{" "}
                <strong>you, the buyer</strong>, never to the company.
                <br />
                <br />
                <strong style={{ color: T.text }}>
                  The legal model:
                ...
                frequent-flyer miles — are not treated as taxable personal
                income. Bites follow the same rebate doctrine. Always confirm
                with your employer's expense policy.
                <br />
                <br />
                <strong style={{ color: T.text }}>What's tracked:</strong> The
                meal cost goes on your company card and to CMS Open Payments.
                Bites accrue to your personal WeCater account. Two separate
                ledgers, no commingling.
              </div>
            </div>
          )}
        </div>
          ...
          <div>
            ...
            >
              <div
                style={{
                  display: "grid",
                  gridTemplateColumns: "70px 1fr 110px 120px",
                  padding: "10px 16px",
                  background: T.surface,
                  borderBottom: `1px solid ${T.border}`,
                  fontSize: 10,
                  ...
                  >
                    ...
                    <div style={{ textAlign: "right" }}>
                      ...
                      <div
                        style={{
                          fontSize: 9,
                          color: o.status === "pending" ? T.warning : T.success,
                          fontWeight: 600,
                        }}
                      >
                        {o.actualRate}X ·{" "}
                        {o.status === "pending" ? "pending" : "available"}
                      </div>
                    </div>
                  </div>
                  {/* Modifier chips row */}
                    ...
                    >
                      ...
                      {o.modifiers.map((m, j) => (
                        <ModifierChip
                          ...
                          bites={m.bites}
                          color={
                            m.label.includes("Welcome") ? T.brand : T.purple
                          }
                        />
                      ))}
                    </div>
                        ...
                        >
                          <div
                            style={{
                              ...
                              height: `${h}%`,
                              background: isLast
                                ? `linear-gradient(180deg, ${T.brand}, ${T.brandDark})`
                                : T.borderLight,
                  ...
                  .map((r, i, arr) => (
                    <div
                      ...
                      style={{
                        ...
                        padding: "10px 14px",
                        borderTop:
                          i === 0 ? "none" : `1px solid ${T.borderLight}`,
                        gap: 10,
                      }}
                    >
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            ...
            >
              "My company pays for the food. Are these Bites taxable income to
              me?"
            </div>
            <div
              style={{ fontSize: 11, color: T.textSecondary, lineHeight: 1.5 }}
            >
              <strong>No.</strong> Per IRS Announcement 2002-18, promotional
              benefits earned through business spending — like frequent-flyer
              miles or loyalty points — are treated as a rebate on the original
              purchase, not personal income. WeCater Bites follow the same
              model.{" "}
              <button
                onClick={() => setShowLegal(true)}
                style={{
          ...
          >
            ...
            <div style={{ fontSize: 13, color: T.text, lineHeight: 1.65 }}>
              <p style={{ marginBottom: 12 }}>
                <strong>IRS Announcement 2002-18:</strong> The IRS has stated it
                will not pursue tax enforcement on the personal use of
                frequent-flyer miles or other in-kind promotional benefits
                earned through business or official travel. The same rebate
                doctrine applies broadly to loyalty points earned on business
                spending — including catering loyalty programs.
              </p>
              <p style={{ marginBottom: 12 }}>
                <strong>Rebate doctrine:</strong> Loyalty points (including
                WeCater Bites) are treated as a discount on the original
                purchase price rather than taxable income to the recipient. This
                is the same legal framework used by airlines, hotels, and credit
              ...
              <p style={{ marginBottom: 12 }}>
                ...
                required to report transfers of value to physicians (including
                catered meals) under the Sunshine Act. The full meal cost is
                what's reported — not the Bites you earn. Bites are a separate
                vendor-to-buyer loyalty incentive and do not affect Open
                Payments reporting.
              </p>
              <p
                style={{
              ...
              >
                This is informational only and not tax or legal advice. Consult
