...
function ProfileListItem({ profile, active, onClick }) {
  ...
  const totalRestrictions =
    dietBreakdown.vegetarian +
    dietBreakdown.vegan +
    dietBreakdown.glutenFree +
    dietBreakdown.nutAllergy;
...
export default function ProfileManager() {
  ...
  const active = useMemo(
    () => profilesData.find((p) => p.id === activeId),
    [activeId, profilesData],
  );
  ...
  const compliancePhysicians =
    active.physicians?.filter((p) => p.ytd / p.threshold > 0.7) || [];
  const dietPct = (n) =>
    active.dietary.total ? Math.round((n / active.dietary.total) * 100) : 0;
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <span style={{ fontSize: 11, color: T.textTertiary }}>
            ...
            profiles ·{" "}
            <strong style={{ color: T.text, fontFamily: fontMono }}>
              {profilesData.reduce((a, p) => a + p.headcount, 0)}
            </strong>{" "}
            people
          </span>
          <button
      ...
      <div style={{ flex: 1, display: "flex", overflow: "hidden" }}>
              ...
              {[
                ...
                <button
                  ...
                  style={{
                    padding: "4px 10px",
                    borderRadius: 12,
                    border: `1px solid ${filter === f.id ? T.brand : T.border}`,
                    background: filter === f.id ? T.brandLight : T.card,
                    color: filter === f.id ? T.brandDark : T.textSecondary,
                    fontSize: 11,
                    fontWeight: 500,
                    cursor: "pointer",
                    fontFamily: font,
        ...
        >
          ...
          >
            ...
            <div style={{ flex: 1 }}>
              ...
              >
                ...
                <span>•</span>
                <span>
                  👤 {active.contact.name} ({active.contact.role})
                </span>
                <span>•</span>
          ...
          <div style={{ display: "flex", gap: 8, marginBottom: 4 }}>
            ...
            <StatBlock
              value={active.dietary.people.length}
              label="Dietary flags"
              color={
                active.dietary.people.length > 0 ? T.warning : T.textSecondary
              }
            />
            <StatBlock value={active.notes.length} label="Notes" />
            <StatBlock
              value={active.competitors.length}
          ...
          {active.notes.find((n) => n.pinned) && (
            <div
              style={{
                ...
                borderRadius: 10,
                background:
                  active.notes.find((n) => n.pinned)?.priority === "high"
                    ? T.dangerBg
                    : T.warningBg,
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ fontSize: 13, color: T.text, fontWeight: 500 }}>
                  {active.notes.find((n) => n.pinned)?.text}
                </div>
              </div>
            </div>
          )}
          ...
          <SectionHeader
            ...
            count={active.dietary.people.length}
          ...
          >
            ...
            >
              {[
                {
                  label: "Vegetarian",
                  count: active.dietary.breakdown.vegetarian,
                  icon: "🌿",
                  color: T.success,
                  bg: T.successBg,
                },
                {
                  label: "Vegan",
                  count: active.dietary.breakdown.vegan,
                  icon: "🌱",
                  color: T.success,
                  bg: T.successBg,
                },
                {
                  label: "Gluten-free",
                  count: active.dietary.breakdown.glutenFree,
                  icon: "🌾",
                  color: T.warning,
                  bg: T.warningBg,
                },
                {
                  label: "Nut allergy",
                  count: active.dietary.breakdown.nutAllergy,
                  icon: "⚠️",
                  color: T.danger,
                  bg: T.dangerBg,
                },
                ...
                <div
                  ...
                  style={{
                    ...
                    padding: "10px 12px",
                    borderRadius: 10,
                    background: d.count > 0 ? d.bg : T.surface,
                    border: `1px solid ${d.count > 0 ? d.color + "33" : T.borderLight}`,
                  }}
                >
                  <div
                    style={{
                  ...
                  >
                    ...
                    <span
                      style={{
                        fontSize: 11,
                        fontWeight: 500,
                        color: d.count > 0 ? d.color : T.textTertiary,
                      }}
                    >
                      {d.label}
                    </span>
                  ...
                  >
                    ...
                    <span style={{ fontSize: 10, color: T.textTertiary }}>
                      of {active.dietary.total} ({dietPct(d.count)}%)
                    </span>
                  </div>
                </div>
              ))}
            ...
            {active.dietary.people.length > 0 ? (
                ...
                {active.dietary.people.map((person, i) => (
                  <div
                    ...
                    style={{
                      ...
                      padding: "8px 0",
                      borderBottom:
                        i < active.dietary.people.length - 1
              ...
              >
                No specific restrictions recorded yet. The chatbot will ask Tina
                at the next visit.
              </div>
            )}
          </div>
          ...
          {active.physicians && active.physicians.length > 0 && (
            <>
              <SectionHeader
                ...
                count={active.physicians.length}
              />
              <div
                style={{
                  background: T.card,
                ...
                {active.physicians.map((phys, i) => {
                  ...
                  return (
                    <div
                      key={i}
                      style={{
                        marginBottom: i < active.physicians.length - 1 ? 16 : 0,
                      }}
                    >
                      <div
                        style={{
                      ...
                      >
                        ...
                        >
                          ...
                          <span
                            style={{ color: T.textTertiary, fontWeight: 500 }}
                          >
                            YTD
                          </span>
                        </span>
                      ...
                      >
                        ${remaining.toFixed(2)} remaining before $100 de minimis
                        threshold{" "}
                        {danger
                          ? "— ⚠️ very close"
                          : warning
          ...
          >
            {showAddNote || true ? (
              <div
                style={{
                  marginBottom: active.notes.length ? 12 : 0,
                  padding: 10,
                  background: T.surface,
                  borderRadius: 10,
                ...
                >
                    ...
                    {[
                      ...
                      <button
                        ...
                        style={{
                          ...
                          background: newPriority === p.id ? p.bg : T.card,
                          color: p.color,
                          fontSize: 10,
                          fontWeight: 600,
                          cursor: "pointer",
                  ...
                  <button
                    ...
                    style={{
                      ...
                      borderRadius: 6,
                      border: "none",
                      background: newNote.trim() ? T.brand : T.border,
                      color: "#fff",
                      fontSize: 11,
                      fontWeight: 600,
          ...
          {active.competitors.length > 0 && (
            <>
              <SectionHeader
                ...
                count={active.competitors.length}
              />
              <div
                style={{
                  background: T.card,
              ...
              >
                ...
                >
                  Other reps observed at this office. The chatbot uses this to
                  suggest differentiated cuisines.
                </div>
                {active.competitors.map((c, i) => (
                  <div
                    ...
                    style={{
                      ...
                      borderRadius: 8,
                      marginBottom: i < active.competitors.length - 1 ? 6 : 0,
                    }}
                  >
                    <div>
                      <span
            ...
            {[
              {
                icon: "🔁",
                label: "Reorder last",
                desc: active.lastOrder
                  ? `${active.lastOrder.restaurant} · $${active.lastOrder.amount}`
                  : "No previous orders",
              },
              {
                icon: "📐",
                label: "Save as template",
                desc: "Reusable order with variables",
              },
              {
                icon: "🔄",
                label: "Switch context",
                desc: "Change to another office",
              },
              {
                icon: "📤",
                label: "Transfer profile",
                desc: "Hand off to another rep",
              },
          ...
          <div style={{ marginTop: 24 }}>
            ...
            >
              ...
              {active.id === "patel" && (
                ...
                >
                  Last 3 orders all $14–16/pp — your sweet spot. Avoid Asian
                  cuisines this week (used twice in April). The Pfizer rep
                  brought sushi 6 days ago — go contrasting.
                </div>
              )}
              {active.id === "morrison" && (
                <div
                ...
                >
                  Dr. Morrison at{" "}
                  <strong style={{ color: T.warning }}>$84.25 YTD</strong>. Next
                  order should be ≤ $15.75 to stay compliant. Suggested: Bobby Q
              ...
              {active.id === "phx-heart" && (
                ...
                >
                  ...
                  — ask Tina at check-in. Plan a safe-bet order: Mediterranean
                  or Mexican (broad appeal).
                </div>
              )}
              {!["patel", "morrison", "phx-heart"].includes(active.id) && (
                ...
                >
                  Steady relationship. Last order pattern suggests trying
                  something new for variety on the next visit.
                </div>
              )}
            </div>
          </div>
          ...
          >
            ...
            >
              <div>
                ...
                >
                  {
                    active.dietary.people.filter((p) => p.source === "explicit")
                      .length
                  }
                </div>
              </div>
              <div>
                ...
                >
                  {
                    active.dietary.people.filter((p) => p.source === "implicit")
                      .length
                  }
                </div>
              </div>
